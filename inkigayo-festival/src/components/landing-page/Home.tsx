      ...
      <section className={styles.container}>
        <div className={styles.bottom_gradient}>
          <ul className={styles.social_medias}>
            <li className={styles.social_media_twitter}><Link href="https://twitter.com/inkigayofestival/" target='_blank'><FontAwesomeIcon icon={faTwitter} style={{color: '#fff', height: '2.5rem', width: '3rem'}} /></Link></li>
